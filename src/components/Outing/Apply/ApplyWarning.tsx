...
const ApplyWaring: FC<Props> = () => {
  return (
    <S.FormReasonSickDesc>
      ...
      <p>
        5. 외출 사이트를 통해서 이루어진 외출신청만 정식 외출로 인정되며, 이외의
        다른 방법으로 신청한 외출은 무단외출로 간주합니다.
      </p>
      <p>
        6. 외출 사이트에서는 24시간제를 사용합니다. (오후6시 외출할 경우 18시로
        신청)
      </p>
    </S.FormReasonSickDesc>
  );
