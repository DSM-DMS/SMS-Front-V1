...
const warningTexts: WarningText[] = [
  ...
  },
  {
    ...
    subText: [
      ...
      "외출이 신청되면 학부모에게 승인 요청 문자가 전송되고, 승인 후에는 본인에게도 승인 안내 문자가 전송됩니다.",
      "(학부모 계정에 연결되지 않은 계정이거나 학부모가 문자 사용을 동의하지 않았다면 학부모 승인 절차를 건너뜁니다.)",
      "본인에게 학부모 승인 안내 문자가 전송되었으면 선생님께 직접 방문하여 최종 승인을 받아주세요.",
